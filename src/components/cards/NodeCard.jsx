...
export default function NodeCard({ node ,isCanvasNode, onConfigure}) {
  ...
  return (
    //     <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 flex justify-between items-center">
    //       <div className="flex-1">
    //         {/* <h5 className="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white mb-2">
    //           {name}
    //         </h5> */}
    //         <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">{server}</p>
    //         <img
    //   src="https://www.svgrepo.com/show/303251/mysql-logo.svg"
    //   alt="MySQL"
    //   className="h-20 w-20"
    ...
    //         </a> */}
    //       </div>
    //       <div className="text-lg font-bold text-green-400">{getTypeLabel(type)}</div>
    //     </div>
